...
double n1 = 1.3; double n2 = 1.3; double n3 = 1.3; //refraction indexes
double loa = 6052; double loc = 6051; double lod = 6052; double lob = 6051; 
double p2d[2];
double cam3[3];
...
//cout<<"not refracted"<<" "<<xpix<<" "<<ypix<<endl;
    if(theta<view){
     if(xprime.Z()<0){
      picture.Fill(xpix,ypix);
     }
