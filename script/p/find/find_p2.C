...
TVector3 xcp(7289.7,193.5,4246.6);       //location of the camera
float alpha = 1.97e3;                    //magnification constant
float angle = 17./180*TMath::Pi();      //angle of rotation of x-axis in camera with respect to the (0,1,0)
float rx = 6.75/180*TMath::Pi();         //angle of roation of k on x direction  
float ry = 1.5/180*TMath::Pi();          //angle of roation of k on x direction 
int tnumber = 38;
ofstream output("chosen_pmts2.txt");
ifstream myReadFile;
myReadFile.open("pos2.txt");
std::string linep;
getline(myReadFile,linep);
float number[38], xc[38], yc[38];
int ip=0;
