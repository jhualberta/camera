...
float angle = para[4];  
float rx =  para[5]-2.5/180*TMath::Pi();
float ry = para[6]-0.5/180*TMath::Pi();
...
int tnumber = 16;
ofstream output("chosen_pmts6.txt");
ifstream myReadFile;
myReadFile.open("pos6.txt");
std::string linep;
getline(myReadFile,linep);
float number[16], xc[16], yc[16];
int ip=0;
