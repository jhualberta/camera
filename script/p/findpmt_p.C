...
float alpha = 1.95e3;                    //magnification constant
float angle = 15.5/180*TMath::Pi();      //angle of rotation of x-axis in camera with respect to the (0,1,0)
...
ofstream output("chosen_pmts.txt");
ifstream myReadFile;
