...
TH2F *picture = new TH2F ("HPicture","calculated",4310,-2155,2155,40,0,40);
picture->SetMarkerStyle(8);
picture->SetMarkerSize(0.5);
...
picture->GetXaxis()->SetTitle("calculated x pixel position");
picture->GetYaxis()->SetTitle("distance to measured pixel");

picture->SetTitle("calculated x vs the distance to measured pixel");
