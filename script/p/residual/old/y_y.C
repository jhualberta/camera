...
TH2F *picture = new TH2F ("HPicture","calculated",4310,-2155,2155,4310,-2155,2155);
...
picture->GetYaxis()->SetTitle("measured y pixel position");

picture->SetTitle("calculated y vs y pixel");
