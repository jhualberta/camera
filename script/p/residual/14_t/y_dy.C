...
picture->GetXaxis()->SetTitle("calculated y pixal position");
picture->GetYaxis()->SetTitle("delta y(number of pixels)");

picture->SetTitle("y position vs delta y");
