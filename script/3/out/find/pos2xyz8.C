...
float angle = 125./180*TMath::Pi();  
float rx = 4.7/180*TMath::Pi();
float ry = -9.5/180*TMath::Pi();
 


int tnumber = 12;
ofstream output("../pmt_3d/pmt_3d8.txt");
ifstream myReadFile;
myReadFile.open("../pos/pos8.txt");
std::string linep;
getline(myReadFile,linep);
float number[12], xc[12], yc[12];
int ip=0;
