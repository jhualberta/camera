...
std::vector<TVector3>testList;	
std::vector<TVector3>avList;

//TVector3 avList(0,0,0);
...
cout<<"start loading measured points"<<endl;
 TVector3 temp;
 ...
 for (int i=0;i<4;i++){
  ...
  if(i==3){
	...
	n = n + tp[i-1];
	     ...
	     cout<<"loaded measured points"<<endl;
...
cout<<"start seach for the point"<<endl;
